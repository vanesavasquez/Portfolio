# Vane-Vas — Design Palette

> Paleta personalizada, luminosa y orgánica, con tonos tierra, celestes y amarillos.

## Colores base

| Nombre | Hex | Uso principal |
|--------|-----|---------------|
| Light Peach | `#F2D5BB` | Background principal, espacios luminosos |
...
| Tipo | Familia | Archivo |
|------|---------|---------|
| Principal (Títulos) | **Against** | `against regular.otf` / `against regular.ttf` |
| Secundaria (Cuerpos) | **Spinnaker** | `Spinnaker-Regular.ttf` |

## Roles semánticos (CSS Variables)

| Variable | Valor | Función |
|----------|-------|---------|
| `--color-bg` | `#F2D5BB` | Fondo general |
| `--color-surface` | `#A9C6D9` | Cards, nav, elementos elevados (celeste suave) |
| `--color-surface-2` | `#A6826D` | Hover states, inputs |
